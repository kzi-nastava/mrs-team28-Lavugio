...
SELECT setval('addresses_id_seq', 15);
...
SELECT setval('vehicles_id_seq', 8);
...
SELECT setval('driver_registration_token_id_seq', 3);
...
SELECT setval('rides_id_seq', 129);
...
SELECT setval('ride_reports_report_id_seq', 2);
