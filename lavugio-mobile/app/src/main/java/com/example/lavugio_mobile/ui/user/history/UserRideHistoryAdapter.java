...
public class UserRideHistoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private static final int VIEW_TYPE_ITEM = 0;
    private static final int VIEW_TYPE_END = 1;

    private final List<RideHistoryUserModel> rides;
    ...
    public interface OnRideClickListener {
        void onRideClick(RideHistoryUserModel ride);
    }

    public UserRideHistoryAdapter(List<RideHistoryUserModel> rides, OnRideClickListener clickListener) {
        this.rides = rides;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemView = inflater.inflate(R.layout.item_user_ride_history_card, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof RideViewHolder && position < rides.size()) {
            RideHistoryUserModel ride = rides.get(position);
    ...
    static class RideViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(RideHistoryUserModel ride, OnRideClickListener clickListener) {
